            ...
            >
              <div class="service-box2_content">
                <div class="service-box2_icon">
                  <img
                    src="assets/img/update1/icon/service_3_1.svg"
                    alt="Icon"
                  />
                </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            ...
            >
              <div class="service-box2_content">
                <div class="service-box2_icon">
                  <img
                    src="assets/img/update1/icon/service_3_2.svg"
                    alt="Icon"
                  />
                </div>
                <h3 class="service-box2_title">
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            ...
            >
              <div class="service-box2_content">
                <div class="service-box2_icon">
                  <img
                    src="assets/img/update1/icon/service_3_3.svg"
                    alt="Icon"
                  />
                </div>
                <h3 class="service-box2_title">
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            ...
            >
              <div class="service-box2_content">
                <div class="service-box2_icon">
                  <img
                    src="assets/img/update1/icon/service_3_4.svg"
                    alt="Icon"
                  />
                </div>
                <h3 class="service-box2_title">
